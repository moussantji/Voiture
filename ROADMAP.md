...
- [x] Geocoding OSM (Nominatim) : recherche « Où allez-vous ? » réelle ✅ fait (preview + app, `src/services/geo.ts`)
- [x] OSRM : itinéraire réel qui suit les rues + distance/durée réelles ✅ fait (gratuit, sans clé ⚖️ fair-use)
