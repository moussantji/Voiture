// 🛠️ Génère app/web-preview/index.html — preview fidèle avec la VRAIE GOOGLE MAPS
// (embed officiel Google Maps — interactif natif : drag/zoom/pinch — sans clé API,
//  + filtre nuit émeraude Niger Royal + repli auto sur carte SVG dessinée si hors-ligne)
...
import {
  BRIDGES, CITY_LABEL, HIGHWAYS, RIVER_LABELS, RIVER_PATH,
...
/* ---- Google Maps iframe (nuit émeraude) ---- */
...
<div class="sub">PREVIEW · GOOGLE MAPS · BAMAKO 🇲🇱</div>
