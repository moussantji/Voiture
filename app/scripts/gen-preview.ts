...
function clientScreen(): string {
  ...
  <div class="popover" id="popover">
    <div class="pop-card"><div class="handle"></div><div class="pop-title">Où allez-vous ?</div><div class="qi qi-map" id="qiMap"><span class="qi-flag"></span><span class="qi-txt"><b>Choisir sur la carte</b><small>Touchez un point directement sur la carte</small></span><span class="qi-chevr">›</span></div>${items}<button class="gbtn outline" id="popClose">Fermer</button></div>
  </div>
</div>`;
}
