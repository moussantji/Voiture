...
function mkMap(el,which){
  ...
  // \u{1F5FA}\uFE0F VRAIES tuiles Google Maps (fran\xE7ais) rendues en mode sombre \u2014 preview de d\xE9mo.
  //    Repli auto : tuiles Google \u2192 CARTO dark (OSM) \u2192 carte SVG.
  const g=L.tileLayer('https://mt{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}&hl=fr',{attribution:'\xA9 Google Maps \xB7 donn\xE9es \xA9 Google / OSM',maxZoom:20,subdomains:'0123'});
  let gErr=0;
